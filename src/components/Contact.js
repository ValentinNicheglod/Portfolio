...
const contactLinks = [
  {
    ...
    class: 'bi bi-github github-icon',
    color: '#24292E',
...
const Contact = ({ smallScreen }) => {
  ...
  return (
    <div className="h-100 vh100 contact-cont">
              ...
              !smallScreen
                  ...
                  <Tooltip title="Gmail" placement="bottom">
                    <a href="mailto:nicheglod69@gmail.com" className="social-btn">
                      <img src="https://img.icons8.com/fluent/50/000000/gmail-new.png" alt="" />
                    </a>
                  </Tooltip>
                  )
          }
      ...
      <div className="bg-white h-50 d-flex justify-content-center row legend">
